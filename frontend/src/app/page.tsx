...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center pt-6 px-6 pb-0 relative overflow-y-auto custom-scrollbar">
      {/* Background Glows */}
      ...
      <main className="max-w-5xl w-full text-center relative z-10 flex flex-col items-center justify-between min-h-[85vh] md:h-[80vh] pt-4">
        <div className="flex flex-col items-center flex-1 justify-center">
          <h1 className="text-4xl xs:text-5xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tight mb-6 bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent leading-[1.05]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 text-left w-full mt-8 md:mt-12">
          {[
            ...
            <div key={i} className="p-4 md:p-5 rounded-xl bg-card/40 border border-white/10 backdrop-blur-sm transition-all flex flex-col justify-center min-h-[80px] md:min-h-[100px]">
      ...
      <footer className="mt-auto pt-8 pb-4 w-full flex justify-center z-10">
        <div className="text-muted-foreground/30 text-[9px] sm:text-[10px] font-bold tracking-[0.2em] uppercase whitespace-nowrap">
